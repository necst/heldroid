...
public class PackageFilter extends FeatureGatherer {
    ...
    private void checkMetrics() {
        if (!super.isAnyFeatureEnabled(FEATURE_AVG_CLASS_SIZE, FEATURE_CLASS_COUNT,
                FEATURE_CLASS_COUNT_IN_MAIN_PACKAGE, FEATURE_MAIN_PACKAGE_OBFUSCATED,
                FEATURE_OBFUSCATION, FEATURE_PACKAGE_COUNT))
            return;

        String mainPackageName = currentData.getManifestReport().getPackageName().replace(".", "/");  // in smali format
